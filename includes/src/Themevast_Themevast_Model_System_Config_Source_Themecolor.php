...
class Themevast_Themevast_Model_System_Config_Source_Themecolor
{
    ...
    public function getAllOptions($withEmpty = true)
    {
        $options = array(
            ...
            array('value'=>'color/home3_red.css', 'label'=>Mage::helper('adminhtml')->__('Home3 Red')),
            array('value'=>'color/home3_orange.css', 'label'=>Mage::helper('adminhtml')->__('Home3 Orange')),
            array('value'=>'color/home3_green.css', 'label'=>Mage::helper('adminhtml')->__('Home3 Green')),
